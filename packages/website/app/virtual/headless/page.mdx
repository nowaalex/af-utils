import GuillotineImage from "./img.tsx";

export const metadata = {
    title: "Docs: Headless",
    description:
        "Headless API is the core of the library and it provides maximum flexibility. You can work with it directly or delegate rendering to List."
};
...
You can work with it directly or delegate rendering to [List](/virtual/list)
