...
-   scroll position persistence after [prepending items](/virtual/react-examples/list/prepend-items);
-   isolated rerendering with separate [subscriptions](/virtual/react-examples/list/extra-events);
-   support of both [react hook](/virtual/react-examples/hook/simple) and [react component](/virtual/react-examples/list/simple) api, which allows to
