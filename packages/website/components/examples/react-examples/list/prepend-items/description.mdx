...
VirtualScroller exposes <AutoLink href={docHref("virtual-core", "VirtualScroller.visibleFrom")}>visibleFrom</AutoLink>,
which allows to get the position of the first visible item
and <AutoLink href={docHref("virtual-core","VirtualScroller.scrollToIndex")}>scroll to it</AutoLink>.
