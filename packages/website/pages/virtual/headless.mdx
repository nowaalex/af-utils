...
### `setContainer: Bound Function(el: HTMLElement) => void`
...
Normally [`setScroller`](#setscroller-bound-functionel-htmlelement--window--void) should be used to pass scroller to model. Use this if scroller is located outside (window scroll).
