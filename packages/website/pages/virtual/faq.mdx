...
are taken with the help of [`getEstimatedItemSize`](/virtual/headless#getestimateditemsize-function-itemsizes-scrollsize-newitemcount---integer) param. But this is usually not
