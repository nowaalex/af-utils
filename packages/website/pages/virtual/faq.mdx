...
In order to work smoothly, library must know scrolled item sizes. Initially they equal [`estimatedItemSize`](/virtual/headless#estimateditemsize-function-itemsizes-scrollsize-newitemcount---integer). But this is usually not
