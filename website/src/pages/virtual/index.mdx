...
description: "Virtualize large lists with variable or fixed item sizes. TypeScript-friendly Solid, React, and core adapters are available."
---

import { Image } from "astro:assets";
import messyImg from "assets/messy.jpg";
import List from "@af-utils/examples/src/virtual/solid/list/simple/src/code";
