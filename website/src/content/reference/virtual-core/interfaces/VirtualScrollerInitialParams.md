---
title: "Interface: VirtualScrollerInitialParams"
description: All VirtualScroller parameters (that may / may not change over time).
package: "@af-utils/virtual-core"
symbol: VirtualScrollerInitialParams
kind: interface
referencePath: /virtual/reference/virtual-core/interfaces/VirtualScrollerInitialParams
generated: true
---
...
Math.min(
    itemCount,
    Math.ceil(estimatedWidgetSize / estimatedItemSize) + overscanCount
);
```
