...
import { VirtualController, virtualGridItem } from "@af-utils/virtual-lit";
...
export default class Grid extends LitElement {
    ...
    private readonly rows = new VirtualController(
        this,
        () => ({
            itemCount: SIZE,
    ...
    private readonly columns = new VirtualController(
        this,
        () => ({
            itemCount: SIZE,
...
customElements.define("af-virtual-lit-custom-layouts-grid", Grid);
